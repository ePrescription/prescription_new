...
use App\prescription\utilities\TreatmentType;
...
class HospitalImpl implements HospitalInterface
{
    ...
    public function getPatientNames($hospitalId, $keyword)
    {
        ...
        try {
            ...
            if (!is_null($hospitalUser)) {
                ...
                $query->where('usr.delete_status', '=', 1);
                $query->where('hp.hospital_id', $hospitalId);
                $query->where('p.name', 'LIKE', $keyword)->orWhere('p.patient_id', '=', $keyword)->orWhere('p.pid', 'LIKE', $keyword . '%');
    ...
    public function saveNewAppointment(NewAppointmentViewModel $appointmentVM)
    {
        ...
        $status = true;
        $patientPrescription = null;
        $treatmentType = TreatmentType::TREATMENT_PLAN_OUTPATIENT;
        ...
        try {
            ...
            if (!is_null($doctor) && !is_null($hospital) && !is_null($patientUser)) {
                ...
                $appointment->appointment_type = $treatmentType;
    ...
    public function getFutureAppointmentsForDashboard($fromDate, $toDate, $hospitalId, $doctorId = null)
    {
        ...
        try {
            ...
            /* if(!is_null($fromDate) && !is_null($toDate)){
                 $query->whereBetween('da.appointment_date', [$fromDate, $toDate]);
                 // dd("TEST FRMDATE");
             }else{
            ...
            /* Selected Dates For View */
            $futureAppointments['fromDate'] = $fromDate;
            $futureAppointments['toDate'] = $toDate;
...
//dd($feeInfo);
    ...
    public function getPatientMedicalProfileForPrint($patientId, $hospitalId)
    {
        ...
        try
        {
            ...
            $patientMedicalProfile['patientDetails'] = $patientDetails;
            $patientMedicalProfile['hospitalDetails'] = $hospitalDetails;
            //$patientMedicalProfile['recentBloodTests'] = $bloodExaminations;
            $patientMedicalProfile['recentComplaints'] = $latestComplaints;
            $patientMedicalProfile['recentGeneralTests'] = $generalExaminations;
            $patientMedicalProfile['recentFamilyIllness'] = $latestFamilyIllness;
            $patientMedicalProfile['recentPastIllness'] = $latestPastIllness;
            $patientMedicalProfile['recentPersonalHistory'] = $latestPersonalHistory;
            $patientMedicalProfile['recentDrugHistory'] = $latestDrugHistory;
            $patientMedicalProfile['recentSurgeryHistory'] = $latestSurgeryHistory;
            $patientMedicalProfile['recentPregnancy'] = $latestPregnancy;
            //$patientMedicalProfile['recentScans'] = $latestScans;
            $patientMedicalProfile['recentSymptoms'] = $latestSymptoms;
            $patientMedicalProfile['diagnosticExaminations'] = $diagnosticExaminations;

            //$patientMedicalProfile['recentUltrasound'] = $latestUltrasound;
            //$patientMedicalProfile['recentUrineExaminations'] = $latestUrineExaminations;
            //$patientMedicalProfile['recentMotionExaminations'] = $latestMotionExaminations;

            //$patientMedicalProfile['dentalExaminations'] = $dentalExaminations;
            //$patientMedicalProfile['xrayExaminations'] = $xrayExaminations;

            //$patientMedicalProfile['latestPrescription'] = $latestPrescription;
        ...
        {
            //dd($queryEx);
            throw new HospitalException(null, ErrorEnum::PATIENT_EXAMINATION_HISTORY_ERROR, $queryEx);
        }
        catch (UserNotFoundException $userExc)
        {
            //dd($userExc);
    ...
    public function getPatientLabProfileForPrint($patientId, $hospitalId)
    {
        ...
        try
        {
            ...
            $patientLabProfile['patientDetails'] = $patientDetails;
            $patientLabProfile['hospitalDetails'] = $hospitalDetails;
            $patientLabProfile['recentBloodTests'] = $bloodExaminations;
            $patientLabProfile['recentMotionExaminations'] = $latestMotionExaminations;
            $patientLabProfile['recentUrineExaminations'] = $latestUrineExaminations;
            $patientLabProfile['recentUltrasound'] = $latestUltrasound;
            $patientLabProfile['recentScans'] = $latestScans;
            $patientLabProfile['dentalExaminations'] = $dentalExaminations;
            $patientLabProfile['xrayExaminations'] = $xrayExaminations;
    ...
    public function getPatientMedicalHistoryForPrint($patientId, $hospitalId)
    {
        try
        {
            ...
            $patientMedicalHistory['patientDetails'] = $patientDetails;
            $patientMedicalHistory['hospitalDetails'] = $hospitalDetails;
            //$patientMedicalProfile['recentBloodTests'] = $bloodExaminations;
            $patientMedicalHistory['recentComplaints'] = $latestComplaints;
            $patientMedicalHistory['recentGeneralTests'] = $generalExaminations;
            $patientMedicalHistory['recentFamilyIllness'] = $latestFamilyIllness;
            $patientMedicalHistory['recentPastIllness'] = $latestPastIllness;
            $patientMedicalHistory['recentPersonalHistory'] = $latestPersonalHistory;
            $patientMedicalHistory['recentDrugHistory'] = $latestDrugHistory;
            $patientMedicalHistory['recentSurgeryHistory'] = $latestSurgeryHistory;
            $patientMedicalHistory['recentPregnancy'] = $latestPregnancy;
            //$patientMedicalProfile['recentScans'] = $latestScans;
            $patientMedicalHistory['recentSymptoms'] = $latestSymptoms;
            $patientMedicalHistory['diagnosticExaminations'] = $diagnosticExaminations;
            $patientMedicalHistory['patientDetails'] = $patientDetails;
            $patientMedicalHistory['hospitalDetails'] = $hospitalDetails;
            $patientMedicalHistory['recentBloodTests'] = $bloodExaminations;
            $patientMedicalHistory['recentMotionExaminations'] = $latestMotionExaminations;
            $patientMedicalHistory['recentUrineExaminations'] = $latestUrineExaminations;
            $patientMedicalHistory['recentUltrasound'] = $latestUltrasound;
            $patientMedicalHistory['recentScans'] = $latestScans;
            $patientMedicalHistory['dentalExaminations'] = $dentalExaminations;
            $patientMedicalHistory['xrayExaminations'] = $xrayExaminations;
        }
        catch (QueryException $queryEx)
        {
            //dd($queryEx);
    ...
    */
    private function generatePID($hospitalId)
    {
        ...
        $count = DB::table('hospital_patient')
            ->whereMonth('created_at', '=', $current_month)
            ->whereYear('created_at', '=', $current_year)
            ->where('hospital_id', '=', $hospitalId)
            ->select(DB::raw('count(patient_id) as count'))->get();
        //dd($count);
