...
<b>{{session('success')}}</b>
                ...
                <!-- form start -->
                    ...
                    @if(count($patientUltraSoundTests)>0)
                        ...
                        <form action="{{URL::to('/')}}/lab/rest/api/ultrasoundtests" role="form" method="POST" onsubmit="return submitForm(this);" class="form-horizontal ">
                            ...
                            @foreach($patientUltraSoundTests as $patientUltraSoundTestsValue)
                                <div class="col-sm-6 form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" class="form-control" name="ultraSoundExaminations[{{$i}}][examinationTime]" id="TestTimes" value="{{date('h:i:s')}}" required="required" />
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="button" value="Cancel" class="btn btn-info waves-effect waves-light" onclick="window.location.href='{{URL::to('/')}}/fronthospital/rest/api/{{Session::get('LoginUserHospital')}}/patients';"/>
