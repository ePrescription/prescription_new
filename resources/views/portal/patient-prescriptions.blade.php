        ...
        <div class="content">
            ...
            <div class="">
                <div class="page-header-title">
                    <h4 class="page-title">Pharmacy Prescriptions List</h4>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <h4 class="m-b-30 m-t-0">Patient Prescriptions Details List</h4>
                                    <form action="{{URL::to('/')}}/patient/rest/api/prescription" method="get" style="line-height:30px;width:500px;float:left;display:none;">
                                        <div class="col-xs-3">
                                            Search By PRID
                                        </div>
                                        <div class="col-xs-5">
                                        ...
                                        @foreach($prescriptions as $prescription)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{URL::to('/')}}/patient/rest/api/prescription/{{$prescription->prescription_id}}"><button type="submit" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View</button></a>
