                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <h4 class="m-b-30 m-t-0">Pharmacy Prescriptions Details List</h4>
                                    <form action="{{URL::to('/')}}/pharmacy/rest/api/prescription" method="get" style="line-height:30px;width:500px;float:left;display:none;">
                                <div class="col-xs-3">
                                Search By PRID
                                </div>
                                <div class="col-xs-5">
