                        ...
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                ...
                                <span style="color:green;">
                                    ...
                                    <form action="{{URL::to('/')}}/doctor/rest/api/{{Auth::user()->id}}/hospital/{{Session::get('LoginUserHospital')}}/patient/{{$patientDetails[0]->patient_id}}/update" role="form" method="POST">
                                        <input type="hidden" name="hospitalId" value="{{Session::get('LoginUserHospital')}}" required="required" />
                                        <input type="hidden" name="doctorId" value="{{Auth::user()->id}}" required="required" />
