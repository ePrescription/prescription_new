                                           ...
                                           <h3>PID:{{session('pid')}}</h3>
                                                ...
                                                <div id="myModal" class="modal">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- form start -->
                                                        <form action="{{URL::to('/')}}/fronthospital/rest/api/referraldoctor"
                                                              role="form" id="referraldoctor" method="POST">
                                                            <div class="col-md-12">
                                                                <style>.control-label {
                                                                        line-height: 32px;
                                                                    }</style>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <label class="col-sm-3 control-label">Hospital
                                                                        Name</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control"
                                                            ...
                                                            <div class="box-footer">
                                                                <button type="submit" class="btn btn-success"
                                                                        style="float:right;">Save Profile
                                                                </button>
                                                            </div>
                                                ...
                                                <!-- form start -->
                                                <form action="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/savepatientwithappointment"
                                                      id="appointment" role="form" method="POST"
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Patient Visiting <span
                                                        ...
                                                        <div class="form-group col-md-12" id="searchPatientBox"
                                                             style="display:none;">
                                                            <label class="col-sm-3 control-label">Search Patient</label>
                                                            <div class="col-sm-9" autofocus>
                                                                <!--
                                                                ...
                                                                <select name="searchPatient" id="searchPatient"
                                                                        style="display: inline"
                                                                        class="chzn-container chzn-container-single chzn-container-active"
                                                                        onchange="javascript:getPatient(this.value);">
                                                                    <option value="">--CHOOSE PATIENT--</option>
                                                                    @foreach($patients as $patient)
                                                                        <option value="{{$patient->patient_id}}">{{$patient->pid}}
                                                                            - {{$patient->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" pattern="[a-zA-Z\s]+"
                                                                       title="Please Enter Characters Onlky"
                                                                       class="form-control" id="name" name="name"
                                                                       value="" required="required"/>
                                                                @if ($errors->has('name'))<p class="error"
                                                                                             style="">{!!$errors->first('name')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Gender <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                <input type="radio" class="form-controlx" id="gender1"
                                                                       name="gender" value="1" required="required"/>&nbsp;&nbsp;Male
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="radio" class="form-controlx" id="gender2"
                                                                       name="gender" value="0" required="required"/>&nbsp;&nbsp;Female
                                                                @if ($errors->has('gender'))<p class="error"
                                                                                               style="">{!!$errors->first('gender')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                @if ($errors->has('address'))<p class="error"
                                                                                                style="">{!!$errors->first('address')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                @if ($errors->has('email'))<p class="error"
                                                                                              style="">{!!$errors->first('email')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" min="0" class="form-control"
                                                                       ...
                                                                       maxlength="10"/>
                                                                @if ($errors->has('telephone'))<p class="error"
                                                                                                  style="">{!!$errors->first('telephone')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <input type="radio" class="form-controlx" id="married2"
                                                                       name="maritalStatus" value="2"
                                                                       required="required"/>&nbsp;&nbsp;Unmarried
                                                                @if ($errors->has('maritalStatus'))<p class="error"
                                                                                                      style="">{!!$errors->first('maritalStatus')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                @if ($errors->has('occupation'))<p class="error"
                                                                                                   style="">{!!$errors->first('occupation')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                @if ($errors->has('relationship'))<p class="error"
                                                                                                     style="">{!!$errors->first('relationship')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                       name="spouseName" id="spouseName" value=""/>
                                                                @if ($errors->has('spouseName'))<p class="error"
                                                                                                   style="">{!!$errors->first('spouseName')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="file" class="form-control"
                                                                       name="patient_photo" id="patient_photo"
                                                                       value=""/>
                                                                @if ($errors->has('patient_photo'))<p class="error"
                                                                                                      style="">{!!$errors->first('patient_photo')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Appointment Type <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                ...
                                                                @if ($errors->has('appointmentCategory'))<p
                                                                        class="error"
                                                                        style="">{!!$errors->first('appointmentCategory')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Appointment Date <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                       name="appointmentDate" id="appointmentDate"
                                                                       value="" required="required"
                                                                       onchange="javascript:appointmentTypePatient(this.value); "/>
                                                                <!--onchange="javascript:appointmentTypePatient(this.value); " -->
                                                                @if ($errors->has('appointmentDate'))<p class="error"
                                                                                                        style="">{!!$errors->first('appointmentDate')!!}</p>@endif
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Doctor Name <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                ...
                                                                <select name="doctorId" id="doctorId"
                                                                        ...
                                                                        onchange="javascript:getTokenId({{Auth::user()->id}},this.value);">
                                                                    <!--Modified By prasanth Start 24-01-2018 -->
                                                                    <option value="">--CHOOSE--</option>
                                                                ...
                                                                @if ($errors->has('doctorId'))<p class="error"
                                                                                                 style="">{!!$errors->first('doctorId')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Appointment Time <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="appointmentTime"
                                                                        id="appointmentTime" required="required">

                                                                    <option value="{{date('H:i:s')}}">{{strtoupper(date('H:i:a'))}}</option>
                                                                    @foreach($time_array as $time_value)
                                                                        <?php $key=array_keys($time_array,$time_value); ?>
                                                                        <option value="{{$key[0]}}"> {{strtoupper($time_value)}} </option>
                                                                    @endforeach

                                                                </select>
                                                                @if ($errors->has('appointmentTime'))<p class="error"
                                                                                                        style="">{!!$errors->first('appointmentTime')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-12" id="token"
                                                             style="display: none;">
                                                            <label class="col-sm-3 control-label">Token ID<span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">
                                                                <b>Your Token ID:</b>
                                                                <p name="tokenId" id="tokenId" required="required"
                                                                   readonly style="font-size: 20px;color: blue;"></p>
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Brief History
                                                                <!-- <span class="red">*</span>--></label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control"
                                                                          name="briefHistory"></textarea>
                                                                @if ($errors->has('briefHistory'))<p class="error"
                                                                                                     style="">{!!$errors->first('briefHistory')!!}</p>@endif
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label class="col-sm-3 control-label">Referral Type <span
                                                                        class="red">*</span></label>
                                                            <div class="col-sm-9">

                                                                <div class="col-sm-9">
                                                                    <input type="radio" class="form-controlx"
                                                                           name="referralType" value="1"
                                                                           required="required" checked
                                                                           onclick="javascript:referralTypePatient(1);"/>&nbsp;&nbsp;Internal
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <input type="radio" class="form-controlx"
                                                                           name="referralType" value="2"
                                                                           required="required"
                                                        ...
                                                        <div id="referralTypeInfo" style="display:none;">
                                                            <div class="form-group col-md-12">
                                                                <label class="col-sm-3 control-label">Doctor
                                                                    Specialization <span class="red">*</span></label>
                                                                <div class="col-sm-6">

                                                                    <select name="referralSpecialty"
                                                                            id="referralSpecialty" class="form-control"
                                                                            onchange="javascript:getDoctors(this.value);">
                                                                        <option value="">--CHOOSE--</option>
                                                                        @foreach($specialties as $specialty)
                                                                            <option value="{{$specialty->id}}">{{$specialty->specialty_name}}</option>
                                                                        @endforeach
                                                                ...
                                                                <div class="col-sm-3">
                                                                    ...
                                                                    <button type="button" id="myBtn">Add Referred
                                                                        Doctor
                                                                    </button>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label class="col-sm-3 control-label">Referred By <span
                                                                            class="red">*</span></label>
                                                                <div class="col-sm-9">


                                                                    <select name="referralDoctor" id="referralDoctor"
                                                                            class="form-control"
                                                                            onchange="javascript:getDoctorInfo();">
                                                                        <option value="">--CHOOSE--</option>
                                                                    </select>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"
                                                                           name="referralHospital" id="referralHospital"
                                                                           value="" readonly/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"
                                                                           name="hospitalLocation" id="hospitalLocation"
                                                                           value="" readonly/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="paymentTypeInfo" style="display:block;">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label class="col-sm-3 control-label">Payment Type <span
                                                                            class="red">*</span></label>
                                                                <div class="col-sm-9">
                                                                    <input type="radio" class="form-controlx"
                                                                           id="payment1" name="paymentType" value="Cash"
                                                                           onclick="enableAmount()"
                                                                           required="required"/>&nbsp;&nbsp;Cash
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <input type="radio" class="form-controlx"
                                                                           id="payment2" name="paymentType" value="Card"
                                                                           onclick="enableAmount()"
                                                                           required="required"/>&nbsp;&nbsp;Card

                                                                    &nbsp; <input type="radio" class="form-controlx"
                                                                                  id="payment3" name="paymentType"
                                                                                  value="Cashless"
                                                                                  onclick="disableAmount()"
                                                                                  required="required"/>&nbsp;&nbsp;Cashless
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="number" min="0" class="form-control"
                                                                           id="fee" name="fee" value=""
                                                                           required="required"/>
                                                                </div>
                                                            </div>

                                                            <div class="form-group col-md-12">
                                                                <label class="col-sm-3 control-label">Payment Status
                                                                    <span class="red">*</span></label>
                                                                <div class="col-sm-9">
                                                                    <input type="radio" class="form-controlx"
                                                                           id="paymentstatus1" name="paymentStatus"
                                                                           value="1" required="required"/>&nbsp;&nbsp;Paid
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <input type="radio" class="form-controlx"
                                                                           id="paymentstatus2" name="paymentStatus"
                                                                           value="0" required="required"/>&nbsp;&nbsp;Unpaid
                                                                    @if ($errors->has('paymentStatus'))<p class="error"
                                                                                                          style="">{!!$errors->first('paymentStatus')!!}</p>@endif
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="box-footer">
                                                        <input type="hidden" class="form-control"
                                                               name="prev_appointment_date" id="prev_appointment_date"
                                                               value=""/>
                                                        <button type="submit" class="btn btn-success"
                                                                style="float:right;">Save & Book Appointment
                                                        </button>
                                                    </div>
        ...
        @section('scripts')
            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    $('input[select=searchPatient]').focus();
            ...
            <script>
                function visitPatient(id) {
                    if (id == 1) {
                      ...
                      //  $("#searchPatientBox").focus();
                        $('input#appointmentDate').val('');
                        $('select#appointmentTime').html('');
                        $("#input#name").focus();
                        $('input#name').attr('readonly', false);
                        $('input#email').attr('readonly', false);
                        $('input#telephone').attr('readonly', false);
                ...
                function appointmentTypePatient(dateValue) {
                    ...
                    if (did != "") {
                        ...
                        // var type= $("selected#visiting").val();
                        var type = $("input[name='visiting']:checked").val();
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.result['result'] == "Doctor Is Not Available") {
                                    ...
                                    $("#appointmentTime").html(terms);
                                } else if (data.message == "No referral doctors list") {
