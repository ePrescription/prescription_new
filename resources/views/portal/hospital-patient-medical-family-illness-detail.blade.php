...
<div class="panel-body">
    ...
    <form role="form" method="POST" class="form-horizontal ">
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[0]->relation}}
                <select class="hidden form-control" name="familyIllness[0][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[1]->relation}}
                <select class="hidden form-control" name="familyIllness[1][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[2]->relation}}
                <select class="hidden form-control" name="familyIllness[2][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[3]->relation}}
                <select class="hidden form-control" name="familyIllness[3][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[4]->relation}}
                <select class="hidden form-control" name="familyIllness[4][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[5]->relation}}
                <select class="hidden form-control" name="familyIllness[5][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[6]->relation}}
                <select class="hidden form-control" name="familyIllness[6][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[7]->relation}}
                <select class="hidden form-control" name="familyIllness[7][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[8]->relation}}
                <select class="hidden form-control" name="familyIllness[8][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[9]->relation}}
                <select class="hidden form-control" name="familyIllness[9][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {{$familyIllness[10]->relation}}
                <select class="hidden form-control" name="familyIllness[10][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                ...
                <input type="text" class="hidden form-control" name="familyIllness[11][familyIllnessName]" value="" required="required">
            </div>
            <div class="col-sm-3">
                {{$familyIllness[11]->relation}}
                <select class="hidden form-control" name="familyIllness[11][relation]">
                    <option>None</option>
                </select>
            </div>
        </div>
