                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel">
                                <a href="#{{URL::to('/')}}/doctor/hospital/{{Session::get('LoginUserHospital')}}/doctor/{{Auth::user()->id}}/patients/appointments?appointmentCategory={{$appointmentCategory->appointment_category}}">
