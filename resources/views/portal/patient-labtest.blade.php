        ...
        <div class="content">
            ...
            <div class="">
                <div class="page-header-title">
                    <h4 class="page-title">Patient Lab Test List</h4>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    <h4 class="m-b-30 m-t-0">Patient Lab Test Details List</h4>
                                                ...
                                                @foreach($labTests as $labTest)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{URL::to('/')}}/patient/rest/api/lab/{{$labTest->labtest_id}}"><button type="submit" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View</button></a>
