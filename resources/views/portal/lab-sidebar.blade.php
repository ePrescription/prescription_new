            ...
            <div class="user-info">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{URL::to('/')}}/lab/rest/api/{{Auth::user()->id}}/profile"> Profile</a></li>
                        <li><a href="{{URL::to('/')}}/lab/rest/api/{{Auth::user()->id}}/editprofile"> Edit Profile</a></li>
                        <li class="divider"></li>
        ...
        <div id="sidebar-menu">
            <ul>
                <li class="@if($dashboard_menu==1) active @endif  treeview">
                    <a href="{{URL::to('/')}}/lab/{{Auth::user()->id}}/dashboard">
