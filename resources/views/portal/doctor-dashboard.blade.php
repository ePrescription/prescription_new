...
@section('scripts')
    <!--Morris Chart-->
    {!!  Html::script(asset('theme/assets/plugins/morris/morris.min.js')) !!}
    {!!  Html::script(asset('theme/assets/plugins/raphael/raphael-min.js')) !!}

    {!!  Html::script(asset('theme/assets/pages/dashborad.js')) !!}
