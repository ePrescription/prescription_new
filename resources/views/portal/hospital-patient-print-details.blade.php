                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/details" title="View Profile"><i class="fa fa-user-circle"></i>View Profile </a>
                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/medical-details" title="Medical Profile"><i class="fa fa-medkit"></i>Medical Profile</a>
                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/prescription-details" title="Medical Prescription"><i class="fa fa-file-text-o"></i>Medical Prescription </a>
                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/lab-details" title="Lab Profile"><i class="fa fa-flask"></i>Lab Profile </a>
                                            <!-- By Ramana 12-01-2018-->
                                            &nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/lab-details-results" title="Print Patient Lab Results"><i class="fa fa-folder-o"></i>Print Patient Lab Results </a>

                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/lab-report-download" title="Lab Report Download"><i class="fa fa-download"></i>Lab Report Download </a>

                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/labreceipts" title="Lab Receipts"><i class="fa fa-money"></i>Lab Receipts </a>
                                            &nbsp;&nbsp;
                                            <a href="{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patient/{{$patientExaminations['patientDetails']->patient_id}}/print" title="Print Medical Profile"><i class="fa fa-print"></i>Print Medical Profile </a>
                                        </div>
                                    </div>
                                    ...
                                    <div id='DivIdToPrint' style="display:block;">
                                            ...
                                            <div class="form-group col-sm-12" style="width: 100%;">
                                                ...
                                                @foreach($patientExaminations['recentComplaints'] as $recentTest)
                                                        <div class="col-sm-6" style="width:50%;float:left;">
                                                            ...
                                                            <br/> <br/>ComplaintName:: {{$recentTest->complaint_name}}
                                        ...
                                        @if(count($patientExaminations['recentPersonalHistory'])>0)
                                                <hr/>
                                            <div class="form-group" style="width: 100%;">
                                                    <label class="col-sm-12 control-label" style="width: 100%; font-weight: bolder">Personal History - {{$patientExaminations['recentPersonalHistory'][0]->personal_history_date}}</label>
                                            </div>
                                            <div class="form-group col-sm-12" style="width: 100%;">
                                        ...
                                        @if(count($patientExaminations['recentSymptoms'])>0)
                                            ...
                                            <div class="form-group col-sm-12" style="width: 100%;">
                                                @foreach($patientExaminations['recentSymptoms'] as $recentTest)
                                                        <div class="col-sm-6" style="width:100%;float:left;">
                                                            Main Symptom:: {{$recentTest->main_symptom_name}}  <br/>
                                            ...
                                            <div class="form-group col-sm-12" style="width: 100%;">
                                                @foreach($patientExaminations['recentSurgeryHistory'] as $recentTest)
                                                    <div class="col-sm-6" style="width:50%;float:left;">
                                                          ...
                                                          Past Surgery::  {{$recentTest->patient_surgeries!=""?$recentTest->patient_surgeries:" "}} <br/> Surgery Date:: {{$recentTest->operation_date=="0000-00-00"?"":$recentTest->operation_date}}
                                        ...
                                        @endif
                                            ...
                                            @if(count($latestPrescription)>0)
                                                <?php $i=0; ?>
                                                <h4 class="m-t-0 m-b-30" style="width: 100%; font-weight: bolder">Prescription Details</h4>
