...
<b>{{session('success')}}</b>
                ...
                <!-- form start -->
                    ...
                    @if(count($patientBloodTests)>0)
                        <form action="{{URL::to('/')}}/fronthospital/rest/api/bloodtests" role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="submit" name="addblood" value="Save BloodTest" class="btn btn-success" style="float: right;"/>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="button" value="Cancel" class="btn btn-info waves-effect waves-light"
                                           onclick="window.location.href='{{URL::to('/')}}/fronthospital/rest/api/{{Auth::user()->id}}/patients';"/>
